...
Elm.Main.make = function (_elm) {
   ...
   p1) {
      return function () {
         ...
         0,
         halfWidth)(_v7.x)) ? _U.replace([["x"
                                          ,0]
                                         ,["y",0]],
         _v7) : A2(physicsUpdate,
         t,
         _U.replace([["vx"
                     ,A4(stepVx,
                     _v7.vx,
                     _v7.vy,
                     _U.cmp(_v7.x,7 - halfWidth) < 0,
                     _U.cmp(_v7.x,
                     halfWidth - 7) > 0)]
                    ,["vy"
                     ,A5(stepVy,
                     ...
                     halfHeight - 7) > 0,
                     _U.cmp(_v7.x,
                     p1.x - 10) > -1 && (_U.cmp(_v7.x,
                     p1.x + 10) < 1 && (_U.cmp(_v7.y,
                     -155) > -1 && _U.cmp(_v7.y,
                     -145) < 1)))]],
         _v7));
      }();
   ...
   _v10) {
      return function () {
         return function () {
            return function () {
               var newBall = _U.eq(_v10.state,
               Pause) ? _v10.ball : A3(updateBall,
               _v9.delta,
               _v10.ball,
               _v10.player);
               var score1 = 0;
            ...
            {case "_Tuple2":
               return function () {
                    ...
                    _L.fromArray([$Graphics$Collage.filled(pongGreen)(A2($Graphics$Collage.rect,
                                 gameWidth,
                                 gameHeight))
                                 ,make(_v14.ball)(A2($Graphics$Collage.oval,
                                 15,
                                 15))
                                 ,make(_v14.player)(A2($Graphics$Collage.rect,
                                 40,
                                 10))
                                 ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                         ,_0: 0
