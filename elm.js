...
Elm.Main.make = function (_elm) {
   ...
   bricks) {
      return function () {
         ...
         0,
         halfWidth)(_v20.x)) ? _U.replace([["x"
                                           ,0]
                                          ,["y",0]],
         _v20) : A2(physicsUpdate,
         t,
         _U.replace([["vx"
                     ,A4(stepVx,
                     _v20.vx,
      ...
      return function () {
         return function () {
            return function () {
               ...
               _v23.bricks,
               _v23.ball);
               var newBall = _U.eq(_v23.state,
               Pause) || (_U.eq(_v23.state,
               Won) || _U.eq(_v23.state,
               Lost)) ? _v23.ball : A4(updateBall,
               _v22.delta,
               _v23.ball,
               _v23.player,
               _v23.bricks);
               var newState = _v22.space && _U.eq(_v23.state,
            ...
            {case "_Tuple2":
               return function () {
                    ...
                    _L.fromArray([$Graphics$Collage.filled(pong)(A2($Graphics$Collage.rect,
                                 ...
                                 15,
                                 15))
                                 ,make(_v27.player)(A2($Graphics$Collage.rect,
                                 80,
                                 10))
                                 ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                         ,_0: 0
                                 ...
                                 Won) ? A2(txt,
                                 $Basics.identity,
                                 msgWon) : _U.eq(_v27.state,
                                 Lost) ? A2(txt,
                                 $Basics.identity,
                                 msgLost) : A2(txt,
                                 $Basics.identity,
                                 msg)))]),
                    makeList(_v27.bricks)(A2($Graphics$Collage.rect,
                    50,
                    10)))));
                 }();}
            _U.badCase($moduleName,
